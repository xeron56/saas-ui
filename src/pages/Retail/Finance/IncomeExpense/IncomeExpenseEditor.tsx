...
const IncomeExpenseEditor: React.FC<IncomeExpenseEditorProps> = ({
  ...
  return (
    <Drawer
      width={920}
      open={open}
      title={t('retail.finance.newIncomeExpense', 'New income or expense')}
      onClose={onClose}
      destroyOnClose
      extra={
        <Button
          ...
          onClick={() => form.submit()}
        >
          {t('retail.finance.saveRecord', 'Save record')}
        </Button>
      }
    >
      ...
      >
        <Row gutter={12}>
          ...
          <Col xs={24} md={8}>
            <Form.Item name="recorded_at" label={t('retail.finance.date', 'Date')}>
        ...
        <Row gutter={12}>
          <Col xs={24} md={8}>
            <Form.Item name="title" label={t('retail.finance.title', 'Title')}>
              <Input maxLength={255} />
            </Form.Item>
          </Col>
          <Col xs={24} md={8}>
        ...
        <Form.List name="tenders">
          {(fields, { add, remove }) => (
            <Space direction="vertical" size={12} style={{ width: '100%' }}>
                  ...
                  <Row key={field.key} gutter={12} align="bottom">
                    <Col xs={24} md={5}>
                      <Form.Item
                        ...
                        label={t('retail.finance.tenderKind', 'Tender')}
                        rules={[{ required: true }]}
                      >
                        <Select
                    ...
                    {isCheque && (
                      <Col xs={24} md={5}>
                        <Form.Item
                          ...
                          label={t('retail.finance.chequeNo', 'Cheque no.')}
                        >
                          <Input maxLength={128} />
                        </Form.Item>
                      </Col>
              ...
              >
                {t('retail.finance.addTender', 'Add tender')}
              </Button>
            </Space>
          )}
        </Form.List>
