...
const DashboardPage: React.FC = () => {
  ...
  const todayMetrics: Metric[] = [
    {
      key: 'summary-sales',
      label: t('retail.dashboard.todaySales', 'Today sales'),
      value: summary?.sales,
      color: '#1677ff',
    ...
    {
      key: 'summary-income',
      label: t('retail.dashboard.todayIncome', 'Today income'),
    ...
    {
      key: 'summary-expense',
      label: t('retail.dashboard.todayExpense', 'Today expense'),
    ...
    },
    {
      ...
      label: t('retail.dashboard.todayPurchase', 'Today purchase'),
  ...
  const rangeMetrics: Metric[] = [
    {
      key: 'income',
      label: t('retail.dashboard.totalIncome', 'Total income'),
    ...
    {
      key: 'expense',
      label: t('retail.dashboard.totalExpense', 'Total expense'),
    ...
    {
      key: 'due',
      label: t('retail.dashboard.totalDue', 'Sales due'),
    ...
    {
      key: 'stock',
      label: t('retail.dashboard.stockValue', 'Stock value'),
  ...
  const countMetrics: Metric[] = [
    {
      key: 'items',
      label: t('retail.dashboard.totalItems', 'Items'),
    ...
    {
      key: 'categories',
      label: t('retail.dashboard.totalCategories', 'Categories'),
    ...
    {
      key: 'profit',
      label: t('retail.dashboard.totalProfit', 'Sale profit'),
    ...
    {
      key: 'loss',
      label: t('retail.dashboard.totalLoss', 'Sale loss'),
  ...
  const seriesColumns: ColumnsType<SeriesRow> = [
    {
      title: t('retail.dashboard.period', 'Period'),
      dataIndex: 'date',
      width: 140,
      render: (value: string) => <Tag icon={<CalendarOutlined />}>{value}</Tag>,
    },
    {
      title: t('retail.dashboard.sales', 'Sales'),
      dataIndex: 'sales',
      render: (value: number) => (
    ...
    {
      title: t('retail.dashboard.purchases', 'Purchases'),
      dataIndex: 'purchases',
      render: (value: number) => (
        <Space direction="vertical" size={4} style={{ width: '100%' }}>
          <span>{money(value)}</span>
    ...
    {
      title: t('retail.dashboard.netMovement', 'Net movement'),
      key: 'net',
      align: 'right',
      render: (_, record) => {
    ...
    <PageContainer>
      <div style={sectionStyle}>
        <Space size={12} wrap>
          ...
          >
            {t('retail.dashboard.refresh', 'Refresh')}
          </Button>
      ...
      <div style={sectionStyle}>
        <div style={sectionHeaderStyle}>
          <Space>
            <BarChartOutlined />
            <strong>{t('retail.dashboard.series', 'Sales and purchases')}</strong>
          </Space>
          <Space wrap>
            <Tag color={(report?.net_profit || 0) >= 0 ? 'green' : 'red'}>
              {t('retail.dashboard.netProfit', 'Net profit')}: {money(report?.net_profit)}
            </Tag>
            <Tag color="blue">
              {t('retail.dashboard.rows', 'Rows')}: {compactNumber(seriesRows.length)}
            </Tag>
          </Space>
        </div>
        <Table<SeriesRow>
