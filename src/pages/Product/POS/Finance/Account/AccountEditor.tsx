...
const AccountEditor: React.FC<AccountEditorProps> = ({
  ...
  return (
    <Drawer
      ...
      title={
        account
          ? t('product.finance.editAccount', 'Edit payment account')
      ...
      extra={
        <Button
          ...
          onClick={() => form.submit()}
        >
          {t('product.finance.saveAccount', 'Save account')}
        </Button>
      }
    >
      <Form
      ...
      >
        <Row gutter={12}>
          <Col xs={24} md={14}>
            <Form.Item
              name="account_name"
              label={t('product.finance.accountName', 'Account name')}
              rules={[{ required: true }]}
            >
              <Input maxLength={255} />
            </Form.Item>
          ...
          <Col xs={12} md={8}>
            <Form.Item
              ...
              label={t('product.finance.openingBalance', 'Opening balance')}
            >
              <InputNumber min={0} style={{ width: '100%' }} />
            </Form.Item>
          </Col>
          <Col xs={12} md={8}>
            <Form.Item name="opening_date" label={t('product.finance.openingDate', 'Opening date')}>
          ...
          <Col xs={12} md={4}>
            <Form.Item
              ...
              label={t('product.finance.showOnInvoice', 'Invoice')}
          ...
          <Col xs={12} md={4}>
            <Form.Item
              name="active"
              label={t('product.finance.active', 'Active')}
              valuePropName="checked"
            >
              <Switch />
            </Form.Item>
