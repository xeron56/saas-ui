...
const PartyReportPage: React.FC = () => {
  ...
  const ledgerColumns = (kind: LedgerKind): ColumnsType<PartyLedgerPartner> => [
    {
      title: t('product.partyReport.party', 'Party'),
    ...
    {
      title: t('product.report.branchRef', 'Branch ref'),
      dataIndex: 'branch_ref',
      width: 120,
      render: (value) => value || '-',
    },
    {
      title: t('product.partyReport.opening', 'Opening'),
    ...
    {
      title: t('product.report.debit', 'Debit'),
    ...
    {
      title: t('product.report.credit', 'Credit'),
    ...
    {
      title: t('product.partyReport.closing', 'Closing'),
  ...
  const topColumns: ColumnsType<PartyMetric> = [
    ...
    {
      title: t('product.partyReport.documents', 'Documents'),
      dataIndex: 'document_count',
      align: 'right',
      width: 110,
    },
    {
      title: t('product.partyReport.grossAmount', 'Gross'),
    ...
    {
      title: t('product.partyReport.returns', 'Returns'),
    ...
    {
      title: t('product.partyReport.netAmount', 'Net'),
  ...
  return (
    <PageContainer>
      <div style={sectionStyle}>
        <Space size={12} wrap>
          ...
          <Input
            ...
            onPressEnter={loadReports}
            placeholder={t('product.partyReport.search', 'Search party')}
            style={{ width: 220 }}
          />
          <Button
            icon={<FilterOutlined />}
      ...
      <Row gutter={[16, 16]} style={{ marginTop: 16 }}>
        <Col xs={24} md={12} xl={6}>
          <div style={metricStyle}>
            <Statistic
              prefix={<TeamOutlined />}
              title={t('product.partyReport.customerAccounts', 'Customer accounts')}
        ...
        <Col xs={24} md={12} xl={6}>
          <div style={metricStyle}>
            <Statistic
              ...
              title={t('product.report.receivableDue', 'Receivable due')}
        ...
        <Col xs={24} md={12} xl={6}>
          <div style={metricStyle}>
            <Statistic
              ...
              title={t('product.report.payableDue', 'Payable due')}
      ...
      <Row gutter={[16, 16]}>
        <Col xs={24} xl={12}>
          <div id="customer-ledger-report-section" style={sectionStyle}>
            <div style={sectionHeaderStyle}>
              <strong>{t('product.partyReport.customerLedger', 'Customer ledger')}</strong>
        ...
        <Col xs={24} xl={12}>
          <div id="supplier-ledger-report-section" style={sectionStyle}>
            <div style={sectionHeaderStyle}>
              <strong>{t('product.partyReport.supplierLedger', 'Supplier ledger')}</strong>
      ...
      <Row gutter={[16, 16]}>
        <Col xs={24} xl={12}>
          <div id="top-customers-report-section" style={sectionStyle}>
            <div style={sectionHeaderStyle}>
              <strong>{t('product.partyReport.topCustomers', 'Top customers')}</strong>
        ...
        <Col xs={24} xl={12}>
          <div id="top-suppliers-report-section" style={sectionStyle}>
            <div style={sectionHeaderStyle}>
              <strong>{t('product.partyReport.topSuppliers', 'Top suppliers')}</strong>
      ...
      <div style={sectionStyle}>
        <div style={sectionHeaderStyle}>
          <strong>{t('product.partyReport.profitLoss', 'Party profit and loss')}</strong>
          <Space>
            <Tag>
              {t('product.report.netSales', 'Net sales')}: {money(profitLoss?.net_sales)}
            </Tag>
            <Tag>
              {t('product.report.netPurchases', 'Net purchases')}:{' '}
              {money(profitLoss?.net_purchases)}
            </Tag>
          </Space>
        </div>
      ...
      <Drawer
        ...
        title={
          ...
          t('product.partyReport.ledgerDetail', 'Ledger detail')
        }
